...
class ImageCropOverlay extends React.Component {
    ...
    render() {
        ...
        if (style.top + style.height > this.props.initialTop + this.props.initialHeight) {
            style.top = this.props.initialTop + this.props.initialHeight - style.height;
        }
        if (style.top < this.props.initialTop) {
            style.top = this.props.initialTop;
        }

        if (style.left + style.width > this.props.initialLeft + this.props.initialWidth) {
            style.left = this.props.initialLeft + this.props.initialWidth - style.width;
        }
        if (style.left < this.props.initialLeft) {
            style.left = this.props.initialLeft;
        }
    ...
    handlePanResponderEnd = (e, gestureState) => {
        ...
        if (state.initialTop + state.initialHeight > this.props.initialTop + this.props.initialHeight) {
            state.initialTop = this.props.initialTop + this.props.initialHeight - state.initialHeight;
        }
        if (state.initialTop < this.props.initialTop) {
            state.initialTop = this.props.initialTop;
        }

        if (state.initialLeft + state.initialWidth > this.props.initialLeft + this.props.initialWidth) {
            state.initialLeft = this.props.initialLeft + this.props.initialWidth - state.initialWidth;
        }
        if (state.initialLeft < this.props.initialLeft) {
            state.initialLeft = this.props.initialLeft;
        }
